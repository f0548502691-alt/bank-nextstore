...
- מצב החיפוש, הסינון, המיון וה-pagination נשמר ב-URL כדי לאפשר שיתוף קישור וחזרה לאותו מצב.
- בזמן טעינה מוצג loading skeleton בטבלה במקום הודעת טקסט בלבד.
- כאשר מתחילה קריאת נתונים חדשה, הקריאה הקודמת מבוטלת בצד הלקוח כדי לא לבזבז עבודה על responses שכבר אינם רלוונטיים.
...
- קיים URL state עבור פילטרים, מיון ועמוד.
- קיים loading skeleton בזמן טעינת טבלה.
- קיימת החלפת request פעיל בזמן קריאת נתונים חדשה בצד הלקוח.
...
| 2026-05-28 | הוספת URL state, loading skeleton וביטול קריאות קודמות |
